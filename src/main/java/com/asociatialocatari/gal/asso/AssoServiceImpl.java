...
public class AssoServiceImpl implements AssoService{
    ...
    private static final Logger logger = LoggerFactory.getLogger(AssoServiceImpl.class);
    ...
    public AssoServiceImpl(Utils utils, AssoRepository assoRepository, SttRepository sttRepository, UserAssoRepository userAssoRepository) {
        this.utils = utils;
