...
public class Apartment {
    @Id
    @GeneratedValue(strategy = GenerationType.AUTO, generator = "apartment_gen")
    @SequenceGenerator(name = "apartment_gen", sequenceName = "gal.apartment_id_seq", allocationSize = 1)
    private Long id;
